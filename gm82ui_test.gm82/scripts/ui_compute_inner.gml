///ui_compute_inner(element,x,y,rotation,xscale,yscale)
var i;
...
with (argument0) {
    ...
    i=0 repeat (ds_list_size(children)) {
        if (!ui_compute_inner(ds_list_find_value(children,i),argument1,argument2,argument3,argument4,argument5)) exit
    i+=1}
