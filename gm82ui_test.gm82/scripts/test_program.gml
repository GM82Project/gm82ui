if (argument0=="create") {
    ...
    ui_set_style(window,test_styler_window)
    ui_set_size(window,0,0,4,0)
    ...
    button=ui_create_button("Button1",test_handler)
    ...
    button=ui_create_button("Button2",test_handler)
        ui_set_style(button,test_styler)
        ui_set_size(button,80,24,0,4)
    ...
    button=ui_create_button("Button3",test_handler)
        ui_set_style(button,test_styler)
        ui_set_size(button,80,24,0,4)
        ui_set_alt(button,"button 3","yep that's a button 3")
    ui_append_child(panel,button)

    //show_message(ui_find_by_name("button 2"))
    //ui_destroy(panel)
}
if (argument0=="step") {
    t=get_timer()
