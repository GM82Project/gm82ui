...
#define ui_push_message
    ...
    if (!ds_map_exists(global.__gm82ui_messages,argument[0])) {    
...
#define ui_settings
    ...
    switch (argument0) {
        ...
        case ui_set_debugmode: global.__gm82ui_debug=!!argument1
    }
...
#define ui_default_styler
    ...
    with (argument0) {
        ...
        if (type==ui_t_label) {
            ...
            draw_sprite_part(global.__gm82ui_buttontex,down*2,76,0,4,4,x+width-4,y)
            draw_sprite_part(global.__gm82ui_buttontex,down*2,0,21,4,4,x,y+height-4)
            draw_sprite_part(global.__gm82ui_buttontex,down*2,76,21,4,4,x+width-4,y+height-4)

            draw_sprite_part_ext(global.__gm82ui_buttontex,down*2,5,0,70,4,x+4,y,(width-8)/70,1,$ffffff,1)
            draw_sprite_part_ext(global.__gm82ui_buttontex,down*2,5,21,70,4,x+4,y+height-4,(width-8)/70,1,$ffffff,1)
            draw_sprite_part_ext(global.__gm82ui_buttontex,down*2,0,5,4,15,x,y+4,1,(height-8)/15,$ffffff,1)
            draw_sprite_part_ext(global.__gm82ui_buttontex,down*2,76,5,4,15,x+width-4,y+4,1,(height-8)/15,$ffffff,1)
